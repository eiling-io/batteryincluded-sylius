...
namespace Tests\EilingIo\SyliusBatteryIncludedPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\EilingIo\SyliusBatteryIncludedPlugin\Behat\Page\Shop\WelcomePageInterface;
